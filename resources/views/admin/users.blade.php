...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body p-0">
        <style>
            ...
            /* Exclude STT (col 1) and Hành động (col 6) from 200px min */
            .admin-users-table th:nth-child(1),
            .admin-users-table td:nth-child(1),
            .admin-users-table th:nth-child(6),
            .admin-users-table td:nth-child(6) { min-width:unset; }
            ...
            /* Center align STT (col 1) and Actions (col 6) */
            .admin-users-table thead th:nth-child(1),
            .admin-users-table tbody td:nth-child(1),
            .admin-users-table thead th:nth-child(6),
            .admin-users-table tbody td:nth-child(6) { text-align: center; }
        </style>
