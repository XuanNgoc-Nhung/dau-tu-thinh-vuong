                        ...
                        <div class="col-12">
                            <form id="withdrawalForm" autocomplete="off">
                                ...
                                <div class="form-group mb-4">
                                    <label class="font-weight-bold">Thông tin ngân hàng rút tiền <span class="text-danger">*</span></label>
                                    <div id="bank_info" class="border rounded p-3 mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" id="bank_name_input" class="form-control" value="{{ $user->profile->ngan_hang }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <label class="font-weight-bold mb-1">Số tài khoản</label>
                                                        <input type="text" id="bank_account" class="form-control" value="{{ $user->profile->so_tai_khoan }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <label class="font-weight-bold mb-1">Chủ tài khoản</label>
                                                        <input type="text" id="bank_holder" class="form-control" value="{{ $user->profile->chu_tai_khoan }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <label class="font-weight-bold mb-1">Số dư hiện tại</label>
                                                        <input type="text" id="current_balance" class="form-control" value="{{ number_format($user->profile->so_du ?? 0, 0, ',', '.') }} VND" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <label class="font-weight-bold">Số tiền muốn rút (VND) <span class="text-danger">*</span></label>
                                                        <input type="text" id="amount" class="form-control" placeholder="Nhập số tiền muốn rút" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <label class="font-weight-bold">Mật khẩu rút tiền <span class="text-danger">*</span></label>
                                                        <input type="password" id="withdrawal_password" class="form-control" placeholder="Nhập mật khẩu rút tiền" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="amount-buttons">
                                                            <button type="button" class="btn btn-outline-secondary btn-sm amount-btn" data-amount="50000">50K</button>
                                        ...
                                        @else
                                            <div class="alert alert-warning">
                                                ...
                                                Bạn chưa cập nhật thông tin ngân hàng. Vui lòng <a href="{{ route('dashboard.ngan-hang') }}" class="alert-link">cập nhật thông tin ngân hàng</a> trước khi rút tiền.
                                            </div>
                                        @endif
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let currentBalance = {{ $user->profile->so_du ?? 0 }};
    ...
    function createWithdrawalRequest(amount, password) {
        console.log('DEBUG: createWithdrawalRequest called with:', { amount, password: '***' });
        ...
        console.log('DEBUG: Request data prepared:', { ...requestData, mat_khau_rut_tien: '***' });
            ...
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    const countdownInterval = setInterval(function() {
                        countdown--;
                        const countdownElement = document.getElementById(toastId + '-countdown');
                        if (countdownElement) {
